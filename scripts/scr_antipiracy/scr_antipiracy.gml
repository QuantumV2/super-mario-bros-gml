...
{
	show_message(@"Unable to detect the ROM file, please ensure it's located in the same folder as this executable. If it exists, please ensure it's unmodified and it's name is \"smb.nes\". 
